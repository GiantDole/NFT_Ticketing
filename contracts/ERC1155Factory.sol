...
import {ERC1155Ticketing} from "./ERC1155Ticket.sol";

contract FactoryERC1155 {

    ERC1155Ticketing[] public tokens; //an array that contains different ERC1155 tokens deployed
    ...
    */
    ...
    {
        ERC1155Ticketing token = tokens[_index];
