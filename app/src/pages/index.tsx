    ...
    return (
      <SLayout>
        <Column maxWidth={1000} spanHeight>
          ...
          <a href="/menu/search" className="card" id="first">
            <h3>Search events &rarr;</h3>
            <p>Find and purchase tickets for events</p>
          </a>

          <a href="menu/wallet" className="card"  id="second">
            <h3>Ticket wallet &rarr;</h3>
            <p>Your previously purchased event tickets</p>
          </a>
